...
const keyAreas:Record<string,AccessArea|AccessArea[]>={
 ...
 campaigns:'marketing',ads:'marketing',creatives:'marketing',integrations:'marketing',marketing_integrations:'marketing',client_marketing_integrations:'marketing',marketing_metrics:'marketing',reports:'marketing',
...
const clientScopedKeys=new Set(['clients','client_processes','client_mind_maps','client_marketing_integrations','marketing_metrics','documents','financial_entries','invoices','onboarding','payments','projects','reports','tasks']);
