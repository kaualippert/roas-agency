...
import './prospects-crm.css';
import './crm-page.css';
import './sidebar-preference.css';
import './crm-pipeline-compact.css';
import './crm-services.css';
import './crm-services-chart.css';
import './crm-lead-manager.css';
...
import './finance.css';
import './dashboard-connected.css';
import './client-hub.css';
import './tasks-enhanced.css';
