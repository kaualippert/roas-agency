...
import {Badge,BriefcaseBusiness,ChartNoAxesColumn,ChartNoAxesCombined,ClipboardCheck,ClipboardList,CreditCard,FolderKanban,Funnel,House,Image,Layers,PlugZap,ReceiptText,Settings,Users,UsersRound} from 'lucide-react';
...
export const pageMeta:Record<string,PageMeta>={
 ...
 integrations:{title:'Integrações',sub:'Conecte seus canais de mídia e centralize os dados de marketing.'},
...
export const navGroups:NavGroup[]=[
 ...
 {label:'MARKETING',items:[{path:'integrations',label:'Integrações',icon:PlugZap},{path:'ads',label:'Anúncios',icon:Badge},{path:'reports',label:'Relatórios',icon:ChartNoAxesColumn},{path:'creatives',label:'Criativos',icon:Image}]},
...
export const genericPageKeys=['ads','creatives'] as const;
export const genericPageIcon:Record<string,LucideIcon>={ads:Badge,creatives:Image,invoices:ReceiptText,payments:CreditCard,integrations:PlugZap,default:Layers,folder:FolderKanban};
